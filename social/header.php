...
function displayMenu()
{
    ...
    <nav class="navbar fixed-top menu">
        <div class="container-fluid">
            <div>
                <a class="blue_hyperlink" style="border:none;" href="http://localhost/social" target="_self" class="nav-brand">
                    <span class="titletext_social">social
                    </span></a>
            </div>
    ...
    <head>
        ...
        <title>Social Network Website</title>
    ...
    <body>
        ...
        <?php
                ...
                <span class='titletext_social blue_hyperlink'>social</span>
                    </nav>";
                }
                ?>
